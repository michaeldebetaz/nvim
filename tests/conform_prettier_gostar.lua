local utils = require("utils.conform.prettierd_gostar")
...
local function get_ctx()
	local filename = "/home/dem/projects/playground/prettierd_gostar/gostar.go"
...
local function debug()
	...
	local text = utils.format_classes(ctx)
